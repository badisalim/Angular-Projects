...
//         return {
//           name: basketName,
//           basketItems: Object.values(purchases[branchName][basketName])
//         };
//       });
...
//       const fbisForProduct = fullProducts.filter(
//         fullProduct => fullProduct.product === productName
//       );
//       const branchNames = _.uniq(fbisForProduct.map(fbi => fbi.branchName));
//       const branches = branchNames.map(branchName => {
//         const basketItems = fbisForProduct.filter(
//           fbi => fbi.branchName === branchName
//         );
